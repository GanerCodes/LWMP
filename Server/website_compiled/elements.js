/* AUTOGENERATED */
 ...
 const  clickDetect  =  (𝚚 , ƒ , base = þF0219 . body) => { 
   const  bþ0E27F  =  mkə(`button` , {[`𝐶`] : `clickDetectExit`} , `✗`) ; 
  base . append(bþ0E27F) ; 
   const  rem  =  AEL(þF0219 , `click` , (ε) => {
     const  cease  =   (...𝔸)=> (ε . stopPropagation() , ε . preventDefault() , 
                bþ0E27F . remove() , rem() , ƒ( ... 𝔸)) ; 
