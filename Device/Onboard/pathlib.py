# https://raw.githubusercontent.com/micropython/micropython-lib/refs/heads/master/python-stdlib/pathlib/pathlib.py
# Changes: glob does `yield self.__class__(full_path)` instead of `yield full_path`
